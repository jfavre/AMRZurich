...
int main(int argc, char **argv)
{
  ...
  VTK_CREATE(vtkHierarchicalDataSetGeometryFilter, clipGeom);
  ...
  VTK_CREATE(vtkHierarchicalPolyDataMapper, clipMapper2);
  ...
  VTK_CREATE(vtkHierarchicalDataSetGeometryFilter, cutterGeom);
  cutterGeom->SetInputConnection(0, cutter->GetOutputPort(0));

  VTK_CREATE(vtkHierarchicalPolyDataMapper, cutterMapper);
  ...
  VTK_CREATE(vtkHierarchicalPolyDataMapper, ocMapper);
